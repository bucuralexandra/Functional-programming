...
workEvents =
    [ { title = "Work event 1"
      ...
      , category = Work
      , url = Just "https://ro.wikipedia.org"
      , tags = []
      , important = False
      }
    , { title = "Work event 2"
...
personalDetails : PersonalDetails
personalDetails =
    { name = "Bucur Alexandra Ioana"
    , intro = "Hello, I am a student, currently in my 3rd year. I am studying Computer Engineering at Thechnical University from Cluj-Napoca"
    , contacts = [ DetailWithName "email" "bucuralexandra@yahoo.com" ,
                  DetailWithName "phone number" "0746997201"]
    , socials = [ DetailWithName "Github" "https://github.com/octocat",
    DetailWithName "LinkedIn" "https://www.linkedin.com/in/alexandra-bucur-2328091a8/" ]
    }
